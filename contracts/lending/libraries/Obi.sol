 ...
 * @notice Defines the data structures and functions to decode data received from Band's oracle
 * @dev The library defines the necessary components to decode data received from Band's oracle.
 * The encoded data follows Band's Oracle Binary Encoding standard.
 * See https://docs.bandchain.org/developer/technical-specifications/obi.html for the full standard specifications.
 **/
library Obi {
